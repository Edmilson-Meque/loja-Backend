...
public class ConteudoResponseDTO {
    ...
    private CategoriaConteudoDTO categoria;
    ...
    public CategoriaConteudoDTO getCategoria() { return categoria; }
    public void setCategoria(CategoriaConteudoDTO categoria) { this.categoria = categoria; }
